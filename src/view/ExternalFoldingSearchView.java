...
public class ExternalFoldingSearchView extends JFrame {
    ...
    public ExternalFoldingSearchView() {
        // Basic window configuration
        setTitle("Función Plegamiento Externa");
        setSize(1000, 1150);
        ...
        titlePanel.setBackground(new Color(155, 89, 182)); // Light purple theme for external folding hash
        titlePanel.setBorder(new EmptyBorder(20, 20, 20, 20));

        JLabel lblTitle = new JLabel("Algoritmo de Función Plegamiento Externa");
        lblTitle.setFont(new Font("Segoe UI", Font.BOLD, 22));
        lblTitle.setForeground(Color.WHITE);
        lblTitle.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel lblSubtitle = new JLabel("Tabla hash por plegamiento con manejo de bloques de disco");
        ...
        lblHashFunction = new JLabel("Función hash: plegamiento % tableSize");
        lblHashFunction.setFont(new Font("Segoe UI", Font.BOLD, 14));
        lblHashFunction.setForeground(new Color(46, 204, 113));

        JLabel lblExternalInfo = new JLabel("Algoritmo: Hash plegamiento externo con resolución de colisiones");
        ...
        JLabel lblInfo = new JLabel("© 2025 - External Hash Folding Algorithm v1.0");
