...
public class ExternalModSearchView extends JFrame {
    ...
    public ExternalModSearchView() {
        // Basic window configuration
        setTitle("Función Módulo Externa");
        setSize(1000, 1150);
        ...
        titlePanel.setBackground(new Color(142, 68, 173)); // Purple theme for external hash
        titlePanel.setBorder(new EmptyBorder(20, 20, 20, 20));

        JLabel lblTitle = new JLabel("Algoritmo de Función Módulo Externa");
        lblTitle.setFont(new Font("Segoe UI", Font.BOLD, 22));
        lblTitle.setForeground(Color.WHITE);
        lblTitle.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel lblSubtitle = new JLabel("Tabla hash con manejo de bloques de disco");
        ...
        lblBlockAccessCount.setForeground(new Color(142, 68, 173));
        ...
        lblHashFunction = new JLabel("Función hash: value % tableSize");
        lblHashFunction.setFont(new Font("Segoe UI", Font.BOLD, 14));
        lblHashFunction.setForeground(new Color(46, 204, 113));

        JLabel lblExternalInfo = new JLabel("Algoritmo: Hash externo con resolución de colisiones");
        ...
        hashTable.getTableHeader().setBackground(new Color(142, 68, 173));
        ...
        scrollPane.setBorder(BorderFactory.createLineBorder(new Color(142, 68, 173), 1));
        ...
        btnInsertValue = createStyledButton("Insertar", new Color(142, 68, 173));
        ...
        btnSearch = createStyledButton("Buscar", new Color(142, 68, 173));
        ...
        JLabel lblInfo = new JLabel("© 2025 - External Hash Modulo Algorithm v1.0");
