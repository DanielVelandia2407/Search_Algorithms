...
public class BinarySearchView extends JFrame {
    ...
    public BinarySearchView() {
        ...
        dataTable.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value,
                ...
                if (row == foundIndex && foundIndex != -1) {
                    ...
                    // Cream más intenso para el elemento medio
                    c.setBackground(new Color(255, 218, 185));
                    c.setForeground(VERY_DARK);
                } else if ((row >= leftIndex && row <= rightIndex) && leftIndex != -1 && rightIndex != -1) {
                    // Light brown para el rango de búsqueda
                    c.setBackground(LIGHT_BROWN);
        ...
        btnLoadFromFile = createStyledButton("Seleccionar Archivo", WARM_BROWN); // Usando color de la paleta
