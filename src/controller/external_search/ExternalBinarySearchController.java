...
public class ExternalBinarySearchController {
    ...
    private List<List<Integer>> blocks; // Lista de bloques, cada bloque contiene una lista de registros ordenados
    ...
    private void loadDataFromFile() {
        ...
        try {
            File file = new File("src/utilities/datos-busqueda-binaria-externa.txt");
